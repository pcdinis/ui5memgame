			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UI5MemGame-display": {
								"semanticObject": "UI5MemGame",
								"action": "display",
								"description": "UI5 Memory Game",
								"title": "UI5 Mem Game",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pt.pcdinis.ui5memgame.ui5memgame",
									"url": sap.ui.require.toUrl("pt/pcdinis/ui5memgame/ui5memgame")
								}
							}
						}
					}
